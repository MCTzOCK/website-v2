            ...
            <SimpleGrid minChildWidth={"240px"} spacing={0} alignItems={"center"} justifyContent={"center"}>
                ...
                <Box marginInline={"4rem"}>
                    ...
                    <Text textAlign={'left'} fontSize={"1.6rem"}>
                        ...
                        for free, take <Link href={"https://github.com/MCTzOCK"} color={"blue.300"}>a look</Link> at the code and maybe learn something new.
                        ...
                        In the future I&#39;m looking forward to learn more skills and to create more projects that I
